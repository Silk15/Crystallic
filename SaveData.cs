...
namespace Crystallic
{
    ...
    public class SaveData
    {
        ...
        public List<ModRequirement> modRequirements = new()
        {
            ...
            {
                modName = "Arcana",
                message = "You have \"Arcana\" and \"Crystallic\" installed without the compatability mod \"Crystallic Arcana\", Crystallic's crystal imbues will not function properly without this requirement! Do note this is only a small incompatibility :)) \n\n Please ensure you have \"Crystallic Arcana\" installed, a link can be found under the \"Requirements\" tab of either mod.",
